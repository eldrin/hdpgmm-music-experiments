...
\begin{itemize}[noitemsep, leftmargin=*]
    ...
    \item \emph{\textbf{KIM}} is a DL model that is trained in a simple self-supervised learning framework. The loss function is calculated by the 

    \item \emph{\textbf{CLMR}}

    \item \emph{\textbf{HDPGMM}}
