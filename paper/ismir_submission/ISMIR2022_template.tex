...
\begin{itemize}[noitemsep, leftmargin=*]
    ...
    \item \emph{\textbf{CLMR}}~\cite{DBLP:conf/ismir/SpijkervetB21} is recent DL based music representation employing the contrastive learning method from~\cite{DBLP:conf/icml/ChenK0H20}. We employed the original implementation of~\cite{DBLP:conf/ismir/SpijkervetB21} that uses the raw audio samples as input feature. For both DL based models, music representation is extracted from the part of network excluding the decision function stage.
